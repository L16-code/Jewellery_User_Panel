...
const Related_Products = () => {
    ...
    const SwiperArrowHandler2 = (val: string) => {
        if (val === "next") {
            ...
            <section className="product__section section--padding pt-0">
                <div className="container">
                    ...
                    <div className="product__section--inner product__swiper--column4 padding swiper">
                        ...
                        <div className="swiper__nav--btn swiper-button-next" onClick={() => SwiperArrowHandler2("next")}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={24}
                                height={24}
                        ...
                        <div className="swiper__nav--btn swiper-button-prev" onClick={() => SwiperArrowHandler2("prev")}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={24}
                                height={24}
