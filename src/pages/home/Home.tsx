            ...
            <main className="main__content_wrapper">
                                ...
                                <div className="home__three--slider__items">
                                            ...
                                            <div className="col-lg-8 col-md-7 offset-lg-2">
                                                <div className="slider__content text-center">
                                                    <h2 className="slider__maintitle text__primary h1">
                                                        Jewelry to fit every budget, occasion, and taste
                                                    </h2>
                                    ...
                                    <div className="hero__slider--layer style3">
                                        <img
                                            ...
                                            src="assets/img/slider/home3-slider1-layer.webp"
                                            alt="slider-img"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="swiper-slide">
                                <div className="home__three--slider__items">
                                    ...
                                    <div className="hero__slider--layer style3">
                                        <img
                                            className="slider__layer--img"
                                            src="assets/img/slider/home3-slider2-layer.webp"
                                            alt="slider-img"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="swiper-slide">
                                <div className="home__three--slider__items">
                                    ...
                                    <div className="hero__slider--layer style3">
                                        <img
                                            className="slider__layer--img"
                                            src="assets/img/slider/home3-slider3-layer.webp"
                                            alt="slider-img"
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-6">
                                <div className="grid__banner--content margin__left">
                                    ...
                                    <p className="grid__banner--desc">
                                        Brighten up your look with vibrant gemstone jewelry.
                                    </p>
                                    <a className="grid__banner--btn primary__btn" href="shop.html">
                                        SHOP NOW
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="container">
                        ...
                        <div className="product__section--inner">
                                        ...
                                        <div className="product__card--thumbnail">
                                            ...
                                            >
                                                ...
                                                <img
                                                    ...
                                                    src="assets/img/product/main-product/product16.webp"
                                                    alt="product-img"
                                                />
                                            </a>
                                    ...
                                    <article className="product__card">
                                        <div className="product__card--thumbnail">
                                            ...
                                            >
                                                ...
                                                <img
                                                    className="product__card--thumbnail__img product__secondary--img"
                                                    src="assets/img/product/main-product/product15.webp"
                                                    alt="product-img"
                                                />
                                            </a>
                                            <ul className="product__card--action">
                                    ...
                                    <article className="product__card">
                                        <div className="product__card--thumbnail">
                                            ...
                                            >
                                                <img
                                                    className="product__card--thumbnail__img product__primary--img"
                                                    src="assets/img/product/main-product/product11.webp"
                                                    alt="product-img"
                                                />
                                                <img
                                                    className="product__card--thumbnail__img product__secondary--img"
                                                    src="assets/img/product/main-product/product14.webp"
                                                    alt="product-img"
                                                />
                                            </a>
                                            <span className="product__badge">-14%</span>
                                    ...
                                    <article className="product__card">
                                        <div className="product__card--thumbnail">
                                            ...
                                            >
                                                <img
                                                    className="product__card--thumbnail__img product__primary--img"
                                                    src="assets/img/product/main-product/product12.webp"
                                                    alt="product-img"
                                                />
                                                <img
                                                    className="product__card--thumbnail__img product__secondary--img"
                                                    src="assets/img/product/main-product/product13.webp"
                                                    alt="product-img"
                                                />
                                            </a>
                                            <ul className="product__card--action">
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                    <article className="product__card">
                                        ...
                                        <div className="product__card--content text-center">
                                            ...
                                            <h3 className="product__card--title">
                                                <a href="product-details.html">
                                                    Sed impedit autem min ver velit?
                                                </a>
                                            </h3>
                                            <div className="product__card--price">
                            ...
                            <div className="product__load--more text-center">
                                <a className="load__more--btn primary__btn" href="shop.html">
                                    Load More
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="row no-gutter mb--n30">
                            <div className="col-lg-6 col-md-6 col-sm-6 mb-30">
                                <div className="banner__box border-radius-5 position-relative">
                                    <a className="display-block" href="shop.html">
                                        <img
                                            className="banner__box--thumbnail border-radius-5"
                                            src="assets/img/banner/banner15.webp"
                                            alt="banner-img"
                                        />
                                        <div className="fullwidth__banner--box__content left">
                                            <p className="fullwidth__banner--box__subtitle">
                                                Store Beautlux
                                            </p>
                                            <h2 className="fullwidth__banner--box__title ">
                                                Jewellery <br />
                                                Online
                                            </h2>
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-6 mb-30">
                                <div className="banner__box border-radius-5 position-relative">
                                    <a className="display-block" href="shop.html">
                                        <img
                                            className="banner__box--thumbnail border-radius-5"
                                            src="assets/img/banner/banner16.webp"
                                            alt="banner-img"
                                        />
                                        <div className="fullwidth__banner--box__content right">
                                            <p className="fullwidth__banner--box__subtitle">
                                                Store Beautlux
                                            </p>
                                            <h2 className="fullwidth__banner--box__title ">
                            ...
                            <div className="col-lg-4 col-md-6 mb-30">
                                <div className="small__product--step">
                                    <div className="section__heading mb-30">
                                        <h2 className="section__heading--maintitle">Featured Products</h2>
                                    </div>
                                    <div className="small__product--step__inner">
                                        <article className="small__product--card d-flex align-items-center">
                                            ...
                                            <div className="small__product--content">
                                                ...
                                                <div className="product__card--price">
                                                    <span className="current__price">$220.52</span>
                                                    <span className="old__price"> $359.00</span>
                                                </div>
                                            </div>
                                        </article>
                                        <article className="small__product--card d-flex align-items-center">
                                            ...
                                            <div className="small__product--content">
                                                ...
                                                <div className="product__card--price">
                                                    <span className="current__price">$210.52</span>
                                                    <span className="old__price"> $330.00</span>
                                                </div>
                                            </div>
                                        </article>
                                        <article className="small__product--card d-flex align-items-center">
                                            ...
                                            <div className="small__product--content">
                                                ...
                                                <div className="product__card--price">
                                                    <span className="current__price">$190.52</span>
                                                    <span className="old__price"> $240.00</span>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                                        ...
                                        <article className="small__product--card d-flex align-items-center">
                                            ...
                                            <div className="small__product--content">
                                                ...
                                                <div className="product__card--price">
                                                    ...
                                                    <span className="old__price"> $220.00</span>
                                                </div>
                                            </div>
                                        </article>
                                        <article className="small__product--card d-flex align-items-center">
                                            ...
                                            <div className="small__product--content">
                                                ...
                                                <div className="product__card--price">
                                                    <span className="current__price">$256.52</span>
                                                    <span className="old__price"> $322.00</span>
                                                </div>
                                            </div>
                                        </article>
                                        <article className="small__product--card d-flex align-items-center">
                                            ...
                                            <div className="small__product--content">
                                                ...
                                                <div className="product__card--price">
                                                    ...
                                                    <span className="old__price"> $256.00</span>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
                ...
                <section className="advice__banner--section section--padding pt-0">
                    <div className="advice__banner--box position-relative">
                        <img
                            ...
                            src="assets/img/banner/banner-fullwidth5.webp"
                            alt="banner"
                        />
                        <div className="advice__banner--content style2">
                            <h2 className="advice__banner--title">Flat 50% Off On Fresh Jewelry</h2>
                            <p className="advice__banner--desc mb-30">
                                50% OFF on the most popular cosmetic brands. Order all classy products
                                today!
                            </p>
                            <a className="advice__banner--btn primary__btn" href="shop.html">
                                SHOP NOW
                            </a>
                        </div>
                    </div>
                            ...
                            <div className="row">
                                <div className="col-lg-8">
                                    <article className="blog__card">
                                        <div className="blog__card--thumbnail">
                                            <a
                                                className="blog__card--thumbnail__link"
                                        ...
                                        <div className="blog__card--content blog__sticky--content">
                                            <div className="blog__meta">
                                                <span className="blog__meta--text">ROBERT SMITH</span>
                                            </div>
                                            <h3 className="blog__card--title">
                                                <a href="blog-details.html">
                                                    Cumque nam tenetur error aliquam autem placeat ratione aut!
                                                </a>
                                            </h3>
                                ...
                                <div className="col-lg-4">
                                    <div className="blog__card--sidebar">
                                        <article className="blog__card mb-30">
                                            <div className="blog__card--thumbnail">
                                                <a
                                                    className="blog__card--thumbnail__link"
                                                    href="blog-details.html"
                                                >
                                                    <img
                                                        className="blog__card--thumbnail__img"
                                                        src="assets/img/blog/blog5.webp"
                                                        alt="blog-img"
                                                    />
                                                </a>
                                            </div>
                                            <div className="blog__card--content">
                                                ...
                                                <h3 className="blog__card--title">
                                                    <a href="blog-details.html">
                                                        Ad esse soluta, is unde totam odio.
                                                    </a>
                                                </h3>
                                                <a className="blog__card--link" href="blog-details.html">
                                                    Read More
                                        ...
                                        <article className="blog__card">
                                            ...
                                            <div className="blog__card--content">
                                                ...
                                                <h3 className="blog__card--title">
                                                    <a href="blog-details.html">Hypoallergenic Wedding Bands</a>
                                                </h3>
                                                <a className="blog__card--link" href="blog-details.html">
                                                    Read More
                                                </a>
                ...
                <section className="testimonial__section testimonial__bg--three section--padding">
                    <div className="container">
                        ...
                        <div className="testimonial__section--inner p-0 testimonial__swiper--column1 swiper">
                            <div className="swiper-wrapper">
                                <div className="swiper-slide">
                                    <div className="testimonial__box">
                                        <div className="testimonial__box--thumbnail">
                                            <img
                                                src="assets/img/other/testimonial5.webp"
                                                alt="testimonial-img"
                                            />
                                        </div>
                                        <div className="testimonial__box--content text-center">
                                            <p className="testimonial__box--desc">
                ...
                <section className="newsletter__section section--padding">
                    <div className="container">
                        <div className="newsletter__inner d-flex newsletter__bg align-items-center justify-content-between">
                            <div className="newsletter__content d-flex align-items-center">
                                <div className="newsletter__email--icon">
                                    <img src="assets/img/icon/email-icon.webp" alt="icon" />
                                </div>
                                <div className="newsletter__content--right">
                                    <h2 className="newsletter__content--title text-white">
                                        NEWSLETTER SIGN UP!
                                    </h2>
                                    <p className="newsletter__content--desc text-white">
                                        And receive $20 coupon for first shopping.
                                    </p>
                                </div>
                            </div>
                            <div className="newsletter__subscribe--style">
